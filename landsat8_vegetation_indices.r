##calculate landsat 8 indices and return them as a data.frame, 
##assumes bands are labeled b1, b2, b3, b4, b5,b6, and b7
##for more about some standard indices see https://landsat.usgs.gov/sites/default/files/documents/si_product_guide.pdf
##see also https://www.harrisgeospatial.com/docs/BroadbandGreenness.html
